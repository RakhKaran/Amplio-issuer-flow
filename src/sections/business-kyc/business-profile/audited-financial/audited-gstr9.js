...
export default function AuditedGSTR9({ currentBaseYear, setPercent, setProgress, currentData, onSave }) {
  ...
  // Helpers
  // -----------------------------
  const getStatusColor = (status) => (status === 'Uploaded' ? 'success' : 'warning');
